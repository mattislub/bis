...
const About: React.FC = () => {
  ...
  const benefits = [
    'חיסכון בזמן וניהול יעיל של משאבי בית הכנסת/הישיבה',
    ...
    <div className="space-y-12">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          מערכת מתקדמת וידידותית למשתמש המיועדת לניהול יעיל של מקומות ישיבה בבתי כנסת/ישיבות,
      ...
      <div className="text-center bg-gray-50 p-8 rounded-lg">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          המערכת מתאימה לבתי כנסת/ישיבות בכל גודל ומספקת כלים מתקדמים לארגון מיטבי.
        </p>
      </div>
    </div>
  );
